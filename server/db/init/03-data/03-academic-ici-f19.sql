...
BEGIN
    ...
    -- * Semester 1
    PERFORM academic.associate_course_with_program(v_program_id, 'c0108000-0000-4000-a000-000000000008', TRUE, 1); -- Mecánica de la partícula
    ...
    PERFORM academic.associate_course_with_program(v_program_id, 'c0406000-0000-4000-a000-000000000006', TRUE, 1); -- Comunicación oral y escrita
    -- * Semester 2
    PERFORM academic.associate_course_with_program(v_program_id, 'c0208000-0000-4000-a000-000000000008', TRUE, 2); -- Estática
    PERFORM academic.associate_course_with_program(v_program_id, 'c0209000-0000-4000-a000-000000000009', TRUE, 2); -- Lenguaje gráfico (corrected)
    ...
    -- * Semester 3
    PERFORM academic.associate_course_with_program(v_program_id, 'c0308000-0000-4000-a000-000000000008', TRUE, 3); -- Dinámica
    PERFORM academic.associate_course_with_program(v_program_id, 'c0308000-0000-4000-a000-000000000019', TRUE, 3); -- Mecánica de materiales
    PERFORM academic.associate_course_with_program(v_program_id, 'c0403000-0000-4000-a000-000000000003', TRUE, 3); -- Métodos numéricos
    PERFORM academic.associate_course_with_program(v_program_id, 'c0301000-0000-4000-a000-000000000001', TRUE, 3); -- Cálculo III
    PERFORM academic.associate_course_with_program(v_program_id, 'c0309000-0000-4000-a000-000000000039', TRUE, 3); -- Geomática
    ...
    PERFORM academic.associate_course_with_program(v_program_id, 'c0205000-0000-4000-a000-000000000005', TRUE, 4); -- Química
    PERFORM academic.associate_course_with_program(v_program_id, 'c0407000-0000-4000-a000-000000000007', TRUE, 4); -- Inglés 7
    PERFORM academic.associate_course_with_program(v_program_id, 'c0401000-0000-4000-a000-000000011102', TRUE, 4); -- Materiales para Ingeniería Civil
    PERFORM academic.associate_course_with_program(v_program_id, 'c0402000-0000-4000-a000-000000011103', TRUE, 4); -- Teoría estructural
    PERFORM academic.associate_course_with_program(v_program_id, 'c0404000-0000-4000-a000-000000011105', TRUE, 4); -- Mecánica del medio continuo
    PERFORM academic.associate_course_with_program(v_program_id, 'c0403000-0000-4000-a000-000000011104', TRUE, 4); -- Geología
    -- * Semester 5
    PERFORM academic.associate_course_with_program(v_program_id, 'c0507000-0000-4000-a000-000000011107', TRUE, 5);  -- Procesos constructivo
    PERFORM academic.associate_course_with_program(v_program_id, 'c0508000-0000-4000-a000-000000011108', TRUE, 5); -- Análisis estructural I
    PERFORM academic.associate_course_with_program(v_program_id, 'c0509000-0000-4000-a000-000000011109', TRUE, 5); -- Geotecnia I
    PERFORM academic.associate_course_with_program(v_program_id, 'c0510000-0000-4000-a000-000000011110', TRUE, 5); -- Hidráulica
    PERFORM academic.associate_course_with_program(v_program_id, 'c0501000-0000-4000-a000-000000011101', TRUE, 5); -- Economía
    ...
    -- * Semester 6
    PERFORM academic.associate_course_with_program(v_program_id, 'c0607000-0000-4000-a000-000000011107', TRUE, 6); -- Instalaciones
    PERFORM academic.associate_course_with_program(v_program_id, 'c0608000-0000-4000-a000-000000011108', TRUE, 6); -- Análisis estructural II
    PERFORM academic.associate_course_with_program(v_program_id, 'c0609000-0000-4000-a000-000000011109', TRUE, 6); -- Geotecnia II
    PERFORM academic.associate_course_with_program(v_program_id, 'c0610000-0000-4000-a000-000000011110', TRUE, 6); -- Hidráulica de canales
    PERFORM academic.associate_course_with_program(v_program_id, 'c0611000-0000-4000-a000-000000011111', TRUE, 6); -- Ingeniería en sistemas I
    PERFORM academic.associate_course_with_program(v_program_id, 'c0612000-0000-4000-a000-000000011112', TRUE, 6); -- Ingeniería económica
    PERFORM academic.associate_course_with_program(v_program_id, 'c0613000-0000-4000-a000-000000011113', TRUE, 6); -- Habilidades directivas
    -- * Semester 7
    PERFORM academic.associate_course_with_program(v_program_id, 'c0708000-0000-4000-a000-000000011108', TRUE, 7); -- Diseño de estructuras de concreto
    PERFORM academic.associate_course_with_program(v_program_id, 'c0709000-0000-4000-a000-000000011109', TRUE, 7); -- Sustentabilidad e impacto ambiental
    PERFORM academic.associate_course_with_program(v_program_id, 'c0710000-0000-4000-a000-000000011110', TRUE, 7); -- Hidrología
    PERFORM academic.associate_course_with_program(v_program_id, 'c0711000-0000-4000-a000-000000011111', TRUE, 7); -- Ingeniería en sistemas II
    ...
    -- * Semester 8
    PERFORM academic.associate_course_with_program(v_program_id, 'c0808000-0000-4000-a000-000000011108', TRUE, 8); -- Diseño de estructuras de acero
