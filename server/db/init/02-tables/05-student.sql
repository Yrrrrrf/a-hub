...
CREATE TABLE student.enrollment (
    ...
    CONSTRAINT unique_student_course_offer UNIQUE (student_id, course_offer_id)
);
...
COMMENT ON COLUMN student.enrollment.course_offer_id IS 'Reference to the specific course offering';
...
CREATE INDEX idx_enrollment_course_offer ON student.enrollment(course_offer_id);
